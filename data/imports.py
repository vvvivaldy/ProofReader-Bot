...
from data.keyboards import kb_free, kb_instruct, kb_reg, kb_unreg, kb_prof, kb_admin, kb_black_list, kb_trader, kb_keys, kb_trader2, kb_leverage, kb_subscribe_on_trader, kb_confirmation, kb_contract, kb_settings, kb_set_leverage, kb_inform
